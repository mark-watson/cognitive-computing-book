...
public class NLPTest extends TestCase {
  ...
  public void testDemoAllNlpAPis() {
    String sentence = "Apple Computer, Microsoft, and Google are in the tech sector. Each is very profitable according to Mr. Smith.";
    System.out.println("\nNew test sentence:\n\n" + sentence + "\n");
    String [] sentences = EntityDetection.sentenceSplitter(sentence);
    ...
    System.out.println("\nNew test sentence:\n\n" + sentence + "\n");
    Set<String> names = EntityDetection.companyNames(sentence);
    ...
    System.out.println("\nNew test sentence:\n\n" + sentence + "\n");
    Set<String> names1 = EntityDetection.locationNames(sentence);
    System.out.println("Location names found: " + names1);

    sentence = "President Bill Clinton left office.";
    System.out.println("\nNew test sentence:\n\n" + sentence + "\n");
    Set<String> names2 = EntityDetection.personNames(sentence);
    ...
    System.out.println("\nNew test sentence:\n\n" + sentence + "\n");
    List<Pair<String, Double>> results = TextClassifier.allRankedCategories(sentence);
    ...
    System.out.println("\nNew test sentence:\n\n" + sentence + "\n");
    String results2 = TextClassifier.bestCategory(sentence);
    System.out.println("Best category found found (HEALTH): " + results2);
    List<Pair<String, Double>> results3 = TextClassifier.allRankedCategories(sentence);
    System.out.println("All ranked categories found (HEALTH): " + results3);
    System.out.println("Best category with score: " + TextClassifier.classifyWithScore(sentence));
  }
